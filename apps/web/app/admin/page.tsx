...
import { apiFetch, pesos } from '@/lib/api';
    ...
    <section className="section pageTop">
      <div className="container adminLayout">
        ...
        <div className="adminContent">
          ...
          <div className="quickGrid"><Link className="card quickCard" href="/admin/inmuebles"><strong>Publicar inmueble</strong><span>Agregar información y fotografías →</span></Link><Link className="card quickCard" href="/admin/facturas"><strong>Gestionar facturas</strong><span>Crear cobros mensuales →</span></Link></div>
        </div>
      </div>
    </section>
  );
