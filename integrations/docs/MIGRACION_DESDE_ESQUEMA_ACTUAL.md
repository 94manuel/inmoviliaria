...
3. Se agregan `Tenant` y `Owner` porque la fuente histórica contiene personas sin correo, contraseña ni cuenta de usuario.
...
6. Ejecute el importador dla fuente histórica en un ambiente de pruebas.
